...
const int ACCESS_VIOLATION = 0x04;


// MEMORY SETTINGS
const int PAGE_SIZE = 4 * 1024; // 4 Kb == 2^12
const int MEMORY_SIZE = PAGE_SIZE * 1024; // 4 Mb
...
const int LDT_SIZE = sizeof(LDT_RECORD) * (PAGES_COUNT - 1) + 2; // 4 kb
